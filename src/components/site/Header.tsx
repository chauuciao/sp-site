...
export function Header({
  ...
  return (
    <header className="mx-auto flex w-full max-w-[1710px] flex-wrap items-start justify-between gap-x-4 gap-y-3 p-6 text-[14px] font-medium leading-[14px] sm:gap-x-6 sm:text-[16px]">
